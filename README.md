...
```
index.html                              Directory of all client landing pages
assets/
...
4. Add a card for them in the root `index.html`.
...
- **Canonical URL.** Currently `https://elyonedge.org/`. Change it if the page deploys elsewhere.
